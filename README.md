...
![Framework of MDP](https://github.com/Azathoth-dll/Pre-process-and-Qlearning-in-BCN/blob/master/img/fig_rl.png?raw=true)
...
![Average Error in K episodes of given 3-nodes system](https://github.com/Azathoth-dll/Pre-process-and-Qlearning-in-BCN/blob/master/img/Fig1.png?raw=true)
...
![Average error in K episodes of given 9-nodes system](https://github.com/Azathoth-dll/Pre-process-and-Qlearning-in-BCN/blob/master/img/Fig2.png?raw=true)
